...
$include_terms  = ! empty( $attributes['includeTerms'] );
$taxonomies     = $attributes['taxonomies'] ?? '';
$use_language   = ! empty( $attributes['useCurrentLanguage'] );
$language       = $use_language && function_exists( 'pll_current_language' ) ? (string) pll_current_language( 'slug' ) : '';
$language       = (string) apply_filters( 'goodblocks_search_language', $language, $attributes );
...
$wrapper_attributes = get_block_wrapper_attributes( [
	...
	'data-include-terms'     => $include_terms ? 'true' : 'false',
	'data-taxonomies'        => esc_attr( $taxonomies ),
