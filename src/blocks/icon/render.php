...
$icons = [
	...
	'train'         => '<rect width="16" height="16" x="4" y="3" rx="2"></rect><path d="M4 11h16"></path><path d="M12 3v8"></path><path d="m8 19-2 3"></path><path d="m18 22-2-3"></path><path d="M8 15h.01"></path><path d="M16 15h.01"></path>',
...
$icon_name = isset( $attributes['iconName'] ) ? (string) $attributes['iconName'] : 'calendar';
if ( ! isset( $icons[ $icon_name ] ) ) {
	$icon_name = 'calendar';
}

$layout = isset( $attributes['layout'] ) ? (string) $attributes['layout'] : 'icon-title';
if ( ! in_array( $layout, [ 'icon-only', 'icon-title', 'icon-text' ], true ) ) {
	$layout = 'icon-title';
}
...
if ( ! in_array( $color, [ 'inherit', 'brand-blue', 'gold', 'white' ], true ) ) {
	$color = 'inherit';
}
...
if ( $layout === 'icon-title' && $title === '' ) {
	$layout = 'icon-only';
}

if ( $layout === 'icon-text' && $title === '' && $text === '' ) {
	$layout = 'icon-only';
}
...
<div <?php echo $wrapper_attrs; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
	<span class="goodblocks-icon__glyph">
		<svg
			...
			aria-hidden="true"
			focusable="false"
		><?php echo $icons[ $icon_name ]; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></svg>
	</span>
	<?php if ( $layout !== 'icon-only' ) : ?>
		<div class="goodblocks-icon__content">
			<?php if ( $title !== '' ) : ?>
				<h3 class="goodblocks-icon__title"><?php echo wp_kses_post( $title ); ?></h3>
			<?php endif; ?>
			<?php if ( $layout === 'icon-text' && $text !== '' ) : ?>
				<p class="goodblocks-icon__text"><?php echo wp_kses_post( $text ); ?></p>
			<?php endif; ?>
		</div>
	<?php endif; ?>
</div>
