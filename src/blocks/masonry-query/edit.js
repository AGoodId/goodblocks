			...
			return allTaxonomies
				.filter(
					( tax ) =>
						...
						typesToCheck.some( ( t ) => tax.types.includes( t ) )
				)
				.map( ( tax ) => ( {
			...
			<InspectorControls>
				...
				>
					<SelectControl
						...
						options={ [
							{
								label: __( 'Inlägg', 'goodblocks' ),
								value: 'posts',
							},
							{
								label: __( 'Sidor', 'goodblocks' ),
								value: 'pages',
							},
							{
								label: __( 'Media', 'goodblocks' ),
								value: 'media',
							},
							{
								label: __( 'Anpassad posttyp', 'goodblocks' ),
								value: 'custom',
							},
							{
								label: __(
					...
					<SelectControl
						...
						options={ [
							{
								label: __( 'Datum', 'goodblocks' ),
								value: 'date',
							},
							{
								label: __( 'Titel', 'goodblocks' ),
								value: 'title',
							},
							{
								label: __( 'Senast ändrad', 'goodblocks' ),
								value: 'modified',
							},
							{
								label: __( 'Slumpmässig', 'goodblocks' ),
								value: 'rand',
							},
							{
								label: __( 'Menyordning', 'goodblocks' ),
								value: 'menu_order',
							},
						] }
						onChange={ ( value ) =>
				...
				>
					...
					<NumberControl
						...
						value={ gap }
						onChange={ ( value ) =>
							setAttributes( { gap: parseInt( value, 10 ) || 0 } )
						}
						min={ 0 }
						max={ 200 }
						suffix="px"
				...
				{ /* IMAGE SETTINGS */ }
				<PanelBody
					title={ __( 'Bildinställningar', 'goodblocks' ) }
					initialOpen={ false }
				>
					<SelectControl
						...
						help={
							imageRatio === 'original'
								? __(
										'Masonry-layout med varierade höjder',
										'goodblocks'
								  )
								: __(
										'Alla bilder får samma proportioner',
										'goodblocks'
								  )
						}
					/>
					...
					{ imageRatio !== 'original' && (
						<SelectControl
							...
							options={ [
								{
									label: __( 'Fyll (beskär)', 'goodblocks' ),
									value: 'cover',
								},
								{
									label: __(
					...
					{ imageSource === 'acf' && (
						<TextControl
							...
							onChange={ ( value ) =>
								setAttributes( { acfImageField: value } )
							}
				...
				{ /* DISPLAY */ }
				<PanelBody
					title={ __( 'Visa information', 'goodblocks' ) }
					initialOpen={ false }
				>
					<ToggleControl
					...
					{ showCategory && (
						<TextControl
							label={ __(
								'Taxonomi för kategori-etikett',
								'goodblocks'
							) }
							help={ __(
								'T.ex. portfolio_client, category. Lämna tomt = filtertaxonomi.',
								'goodblocks'
							) }
							value={ categoryTaxonomy || '' }
							onChange={ ( value ) =>
								setAttributes( { categoryTaxonomy: value } )
							}
						/>
					) }
					...
					<SelectControl
						...
						options={ [
							{
								label: __( 'Ingen', 'goodblocks' ),
								value: 'none',
							},
							{
								label: __( 'Gradient', 'goodblocks' ),
								value: 'gradient',
							},
							{
								label: __( 'Solid', 'goodblocks' ),
								value: 'solid',
							},
							{
								label: __( 'Blur', 'goodblocks' ),
								value: 'blur',
							},
						] }
						onChange={ ( value ) =>
					...
					{ overlayStyle !== 'none' && (
						<>
							...
							<SelectControl
								...
								options={ [
									{
										label: __( 'Alltid', 'goodblocks' ),
										value: 'always',
									},
									{
										label: __( 'Vid hover', 'goodblocks' ),
										value: 'hover',
									},
								] }
								onChange={ ( value ) =>
				...
				{ /* HOVER EFFECTS */ }
				<PanelBody
					title={ __( 'Hover-effekter', 'goodblocks' ) }
					initialOpen={ false }
				>
					<SelectControl
						...
						options={ [
							...
							{
								label: __( 'Zooma', 'goodblocks' ),
								value: 'zoom',
							},
							{
								label: __( 'Lyft', 'goodblocks' ),
								value: 'lift',
							},
							{
								label: __( 'Gråskala', 'goodblocks' ),
								value: 'grayscale',
							},
							{
								label: __( 'Ljusare', 'goodblocks' ),
								value: 'brightness',
							},
						] }
						onChange={ ( value ) =>
				...
				{ /* CLICK ACTION */ }
				<PanelBody
					title={ __( 'Klickbeteende', 'goodblocks' ) }
					initialOpen={ false }
				>
					<SelectControl
						...
						options={ [
							{
								label: __( 'Öppna lightbox', 'goodblocks' ),
								value: 'lightbox',
							},
							{
								label: __( 'Gå till inlägg', 'goodblocks' ),
								value: 'link',
							},
							{
								label: __( 'Ingen', 'goodblocks' ),
					...
					{ clickAction === 'lightbox' && (
						<>
							...
							<ToggleControl
								label={ __(
									'Visa info i lightbox',
									'goodblocks'
								) }
								checked={ attributes.lightboxShowInfo }
								onChange={ ( value ) =>
									setAttributes( { lightboxShowInfo: value } )
								}
							/>

							<ToggleControl
								label={ __(
									'Visa länk till inlägg',
									'goodblocks'
								) }
								checked={ attributes.lightboxShowLink }
								onChange={ ( value ) =>
									setAttributes( { lightboxShowLink: value } )
								}
							/>
							<ToggleControl
								label={ __(
									'Visa bildtext i lightbox',
									'goodblocks'
								) }
							...
							{ taxonomies.length > 0 && (
								<div>
									...
									>
										{ __(
											'Välj vilka taxonomier som visas som taggar i lightboxen. Lämna tomt = alla.',
											'goodblocks'
										) }
									</p>
									{ taxonomies.map( ( tax ) => (
					...
					{ clickAction === 'link' && (
						<SelectControl
							...
							options={ [
								{
									label: __( 'Samma fönster', 'goodblocks' ),
									value: '_self',
								},
								{
									label: __( 'Nytt fönster', 'goodblocks' ),
									value: '_blank',
								},
							] }
							onChange={ ( value ) =>
				...
				{ /* FILTERING */ }
				<PanelBody
					title={ __( 'Filtrering', 'goodblocks' ) }
					initialOpen={ false }
				>
					<ToggleControl
						label={ __(
							'Aktivera filternavigering',
							'goodblocks'
						) }
						checked={ enableFiltering }
						onChange={ ( value ) =>
							setAttributes( { enableFiltering: value } )
						}
					/>
					...
					{ enableFiltering && (
						<>
							...
							<SelectControl
								...
								options={ [
									{
										label: __( 'Tabs', 'goodblocks' ),
										value: 'tabs',
									},
									{
										label: __( 'Knappar', 'goodblocks' ),
										value: 'buttons',
									},
									{
										label: __( 'Dropdown', 'goodblocks' ),
										value: 'dropdown',
									},
								] }
								onChange={ ( value ) =>
							...
							<TextControl
								...
								value={ filterAllText }
								onChange={ ( value ) =>
									setAttributes( { filterAllText: value } )
								}
							/>
						</>
					) }
				...
				{ /* PAGINATION */ }
				<PanelBody
					title={ __( 'Pagination', 'goodblocks' ) }
					initialOpen={ false }
				>
					<ToggleControl
				...
				{ /* ANIMATION */ }
				<PanelBody
					title={ __( 'Animation', 'goodblocks' ) }
					initialOpen={ false }
				>
					<ToggleControl
						label={ __(
							'Aktivera inladdningsanimation',
							'goodblocks'
						) }
						...
						<>
							<SelectControl
								...
								options={ [
									...
									{
										label: __( 'Scale', 'goodblocks' ),
										value: 'scale',
									},
									{
										label: __( 'Slide up', 'goodblocks' ),
										value: 'slide-up',
									},
								] }
								onChange={ ( value ) =>
				...
				<ServerSideRender
					...
					EmptyResponsePlaceholder={ () => (
						<Placeholder
							...
							instructions={ __(
								'Inga resultat hittades. Justera dina inställningar.',
								'goodblocks'
							) }
						/>
					) }
